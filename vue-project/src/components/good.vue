<template>
    ...
    <div class="cart-product-title clearfix">
        <div class="td-check fl"><span class="check-span fl check-all"><input type="checkbox"></span>全选</div>
    ...
    <div class="cart-product clearfix">
        <table>
            <tbody><tr>
                <td class="td-check"><span class="check-span"><input type="checkbox"></span></td>
            ...
            <tr>
                <td class="td-check"><span class="check-span check-true"><input type="checkbox"></span></td>
                <td class="td-product"><img src="testimg.jpg" width="98" height="98">
                    <div class="product-info">
                        <h6>【斯文】甘油&nbsp;|&nbsp;丙三醇</h6>
                        <p>品牌：韩国skc&nbsp;&nbsp;产地：韩国</p>
