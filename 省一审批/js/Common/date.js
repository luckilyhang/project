...
var date = function ($) {
  ...
  $.fn.hotelDate = function (options) {
    ...
    function initTemplate() {
      ...
      // 主容器模板
      var dateTemplate = '\n        <div class =\'date container c-gray\'>\n <h4 class="tac bold" style="height:40px;line-height:40px;position:fixed;top:0;left：0;margin:0;width:100%;background:#fff;z-index:1000;-webkit-transform: translateZ(0)">\u8BF7\u9009\u62E9<span class=\'c-blue\'>出发</span>\u548C<span class=\'c-red\'>返回</span>\u65F6\u95F4</h4>\n    <div class="data-content" style="width:100%; position:absolute;padding-top:20px;padding-bottom:40px;box-sizing:border-box;overflow-y:scroll;-webkit-overflow-scrolling: touch !important;"></div>     <div class=\'close-btn\' style="position:fixed;width:100%;height:40px;bottom:0;left:0;-webkit-transform: translateZ(0)">\u786E\u5B9A</div>\n        </div>      \n      ';

      $('body').append(dateTemplate); // 向body添加插件

      // action容器模板
      dateArr.forEach(function (item, index) {
        var template = '\n <div class=\'action mt10\' style="">\n            <div class=\'title tac c-blue\'><div class="y">' + item.getFullYear() + '</div>\u5E74<div class="m">' + (item.getMonth() + 1) + '</div>\u6708</div>\n<ul class=\'week border-bottom\'><li>\u65E5</li><li>\u4E00</li><li>\u4E8C</li><li>\u4E09</li><li>\u56DB</li><li>\u4E94</li><li>\u516D</li></ul>\n<ul class=\'day f-small\'></ul>\n          </div>        \n        ';
      ...
      $('.close-btn').on('click', function () {
        ...
        $('.leavetime').text(leaveYear + '/' + leaveTime);
        $('#entertime').html(enterYear + '/' + enterTime + '-' + leaveYear + '/' + leaveTime);
	$('#entertime').css('color','#000')

        $('.input-enter').val(enterYear + '/' + enterTime);
        //console.log(enterYear + '/' + enterTime)
    ...
    function initDay() {
      ...
      leaveDay.length === 1 ? leaveDay = '0' + leaveDay : false;
      var leaveTime =leaveYear+'/'+ leaveMonth + '/' + leaveDay;
      $('.entertime').text(enterTime); // 显示
      $('.leavetime').text(leaveTime);
      $('.input-enter').val(enterYear + '/' + enterTime);
      $('.input-leave').val(leaveYear + '/' + leaveTime);
      //$('#entertime').val(enterYear + '/' + enterTime + '-' + leaveYear + '/' + leaveTime)
    }
