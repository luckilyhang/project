                ...
                success: function (data) {
                    ...
                    if (data != null && data.length > 0) {
                        mui.each(data, function (index, result) {
                            ...
                            if (result.ProjectTypeName == data[0].ProjectTypeName) {
                                html += '<li  name="' + result.ProjectTypeName + '" data-value="' + result.ProjectName + '" data-tags="' + result.ProjectName + '"  class="mui-table-view-cell mui-indexed-list-item mui-radio mui-left" style="margin-top:0;padding-right: 0px;padding-left: 40px;" onclick="fullSelect(this)">';
                            }else{
                                html += '<li  name="' + result.ProjectTypeName + '" data-value="' + result.ProjectName + '" data-tags="' + result.ProjectName + '"  class="mui-table-view-cell mui-indexed-list-item mui-radio mui-left" style="display:none" onclick="fullSelect(this)">';
                            }
                            ...
                            html += '       <h5>负责人：' + result.PersonName + '</h5>';
                            ...
                            html += '       <input name="button" type="button" value="确定" onclick="conFirmSelect(this)" style="float:right;background-color:#7FBCFF;margin-right:10px;border-radius:15px;border-left-width: 0px;border-top-width: 0px;border-bottom-width: 0px;border-right-width: 0px;"/>'
                    ...
                    for (var i in proNames) {
                        ...
                        if (j > 1) {
                            ...
                            proType += ' <div class="proType_selected" onclick="changeType(this)">' + proNames[i] + '</div>';
                        }
