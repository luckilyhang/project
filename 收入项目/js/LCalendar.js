    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function popupYM(e) {
                ...
                _self.gearDate.className = "gearDate";
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    '<div class="date-month" style="position:absolute;top:0;left:0;z-index:1000;background-color:#fff;width:100%;height:40px;text-align: center;line-height:40px;border-bottom:2px solid  #0ecab3;color: #0ecab3;font-size:15px">选择月份</div>' +
                    '<div class="date_roll_mask">' +
                    '<div class="ym_roll">' +
                    '<div>' +
                    '<div class="gear date_yy" data-datetype="date_yy"></div>' +
                    ...
                    '<div class="date_btn_box" style="display:flex;justify-content: space-around;background:#fff">' +
                    '<div class="date_btn lcalendar_cancel"><button style="width:60px;height:25px;background:#fff;border-radius:10px;border:1px solid #000;line-height:25px;color:#000">取消</button></div>' +
                    '<div class="date_btn lcalendar_finish" id="sure" ><button style="width:60px;height:25px;background:#fff;border-radius:10px;color:#0ecab3;border:1px solid #0ecab3;line-height:25px">确定</button></div>' +
                    '</div>' +
                    '</div>' +
                    '</div>';
                document.body.appendChild(_self.gearDate);
            ...
            function closeMobileCalendar(e) {
                ...
                var num=$('#inf-nian').html().substr(0,4);
                var num1=$('#inf-yue').html().substr(0,2);
                doc=num+num1;
                console.log(doc);
            ...
            function finishMobileYM(e) {
                ...
                var date_mm = parseInt(Math.round(_self.gearDate.querySelector(".date_mm").getAttribute("val"))) + 1;
                date_mm = date_mm > 9 ? date_mm : '0' + date_mm;
                $('#inf-nian').html((date_yy % passY + _self.minY)+'年');
                $('#inf-yue').html(date_mm+'月');
